...
/*     Object[] obj = {"첫번째원소", true};
    obj = new Object[] {1, 2};
    
 */    		
    List<Object[]> boardsWithcheckMyId = new ArrayList<>();
    for (Board board : boards) {
    	boolean checkMyId = (board.getUser().getId().equals(loginId)) ? true : false;
    	Object[] boardAndcheckMyId = {board, checkMyId};
    	boardsWithcheckMyId.add(boardAndcheckMyId);
    }
    ...
    String text = gson.toJson(boardsWithcheckMyId);
